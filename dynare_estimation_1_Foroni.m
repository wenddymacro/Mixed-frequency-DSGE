...
global M_ options_ oo_ estim_params_ bayestopt_ dataset_ dataset_info mixed_frequency
...
if ~isequal(options_.mode_compute,0) && ~options_.mh_posterior_mode_estimation
    ...
    % my changes!!!!!!!!!!!
    if (mixed_frequency == true)
        objective_function = str2func('dsge_likelihood_my_dsge');
